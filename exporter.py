...
def _write_saved_model_checkpoint(saved_model_path,
...
#                     outputs)
  checkpoint_path = tf.train.latest_checkpoint('/home/leike/proj/code_practice/python_code/Custom-Object-Detection/train')
  print(checkpoint_path)
  _write_saved_model_checkpoint(saved_model_path, checkpoint_path, placeholder_tensor,
                     outputs)
